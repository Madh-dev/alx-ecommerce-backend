# Generated by Django 5.2.8 on 2025-11-16 03:46
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['price'], name='store_produ_price_2d55a6_idx'), models.Index(fields=['category'], name='store_produ_categor_6683b7_idx'), models.Index(fields=['-created_at'], name='store_produ_created_0fbdf8_idx')],
            },
        ),
    ]
